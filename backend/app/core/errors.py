...
ERRORS = {
    ...
    "WARNING_NOT_FOUND": ("预警不存在或无权访问", 404),
    "WARNING_ROLE_NOT_ALLOWED": ("当前角色不允许执行该预警操作", 403),
    "WARNING_STAGE_INVALID": ("预警来源审核阶段无效", 409),
    "WARNING_STATUS_INVALID": ("当前预警状态不允许该操作", 409),
    "WARNING_ACKNOWLEDGEMENT_REQUIRED": ("请先确认知悉预警", 409),
    "WARNING_REMEDIATION_REVIEW_INVALID": ("关联整改复审无效或尚未完成", 409),
