...
def test_openapi_uses_external_names_and_secures_all_business_routes() -> None:
    ...
    expected_paths = {
        ...
        "/api/v1/users/{userId}",
            ...
            "/api/v1/contracts/{contractId}/files/{contractFileId}/download",
            "/api/v1/reviews",
        ...
        "/api/v1/warnings",
        "/api/v1/warnings/{warningId}",
        "/api/v1/warnings/{warningId}/legal-confirm",
        "/api/v1/warnings/{warningId}/legal-withdraw",
        "/api/v1/warnings/{warningId}/risk-activate",
        "/api/v1/warnings/{warningId}/waive",
        "/api/v1/warnings/{warningId}/acknowledge",
        "/api/v1/warnings/{warningId}/close",
        "/api/v1/warnings/{warningId}/reopen",
        "/api/v1/feedback",
